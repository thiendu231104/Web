...
/**
 * Component Memoized hiển thị danh sách tin nhắn chat, tách biệt hoàn toàn khỏi State nhập liệu
 */
      ...
      {messages.map((msg) => (
        ...
        >
          ...
          <div className="max-w-[85%] space-y-2">
            ...
            {/* Render UI Cards bên ngoài bong bóng chat */}
...
/**
 * Component Input Form riêng biệt chứa State gõ phím độc lập, tránh re-render toàn bộ Chatbot Component
 */
const ChatInputForm = React.memo(function ChatInputForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="p-3 border-t border-slate-100 bg-white flex items-center space-x-2">
      <input
        type="text"
